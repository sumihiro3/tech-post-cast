...
export class TechPostCastBackendStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props: cdk.StackProps, stage: StageConfig) {
    super(scope, id, props);

    // ECR
    const repository = new ecr.Repository(this, 'TechPostCastBackendRepository', {
    ...
    backendLambdaErrorAlarm.addAlarmAction(new cloudWatchActions.SnsAction(errorTopic));
